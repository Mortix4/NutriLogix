package com.example.nutrilogix.RecipesPage.Adapters;
...
import com.example.nutrilogix.RecipesPage.RecipesRecipe;
...
public class AdapterPopular extends RecyclerView.Adapter<AdapterPopular.myviewholder>{
    ...
    public void onBindViewHolder(@NonNull myviewholder holder, int position) {
        ...
        holder.img.setOnClickListener(v ->{
            Intent intent = new Intent(context, RecipesRecipe.class);
